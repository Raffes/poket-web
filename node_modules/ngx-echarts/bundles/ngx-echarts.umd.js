(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@juggle/resize-observer'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-echarts', ['exports', '@angular/core', '@juggle/resize-observer', 'rxjs', 'rxjs/operators'], factory) :
    ...
    ***************************************************************************** */
    ...
    var NgxEchartsDirective = /** @class */ (function () {
        ...
        NgxEchartsDirective.prototype.ngOnInit = function () {
            var _this = this;
            if (this.autoResize) {
                this.resizeSub = new resizeObserver.ResizeObserver(function () {
        ...
        NgxEchartsDirective.prototype.ngAfterViewInit = function () {
            var _this = this;
            this.initChartTimer = window.setTimeout(function () { return _this.initChart(); });
        };
